...
* @version $Id: mini_cal.php,v 1.4 2007/08/05 09:39:57 angelside Exp $
...
$phpbb_portal_path = './portal';

include_once($phpbb_portal_path . '/includes/mini_cal/mini_cal_config.'.$phpEx);
include_once($phpbb_portal_path . '/includes/mini_cal/mini_cal_common.'.$phpEx);
include_once($phpbb_portal_path . '/includes/mini_cal/calendarSuite.'.$phpEx);
// get the mode (if any)
$mini_cal_mode = 0;
